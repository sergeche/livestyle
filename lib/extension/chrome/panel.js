...
require(['lodash', 'extension/panelView', 'extension/patchHistory', 'chrome/utils', 'chrome/styles'], function(_, panelView, patchHistory, utils, styles) {
	...
	function handleSocketMessage(message) {
		switch (message.action) {
			...
			case 'updateFiles':
				...
				break;
			case 'renameFile':
				console.log('Remaning', message.data);
