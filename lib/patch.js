...
define(function(require, exports, module) {
	...
	var cssParser = require('../node_modules/emmet/lib/parser/css');
	var cssEditTree = require('../node_modules/emmet/lib/editTree/css');
	...
	return {
		...
		patch: function(source, patches, options) {
			...
			_.each(patches, function(patch) {
				...
				if (!section) {
					bestPartialMatch(cssTree, cssPath, patch, options);
				} else {
