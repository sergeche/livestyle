...
define(function(require, exports, module) {
	...
	var commentsUtils = require('../../node_modules/emmet/lib/utils/comments');
	...
	Selector.prototype = {
		...
		/**
		 * Returns array of fragments of current selector.
		 * Simple concatenation of these fragments will produce full selector
		 * @return {Array} Array of string fragments
		 */
		fragments: function() {
			if (!this._fragments) {
				var out = [];
	...
	return {
		...
		/**
		 * Factory method that creates SelectorPart instance from given
		 * selector string
		 * @param  {String} sel
		 * @return {SelectorPart}
		 */
		createPart: makeSelectorPart,
