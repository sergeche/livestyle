...
define(function(require, exports, module) {
	 ...
	 * @return {Array}
	 */
	function getProperties(node, syntax) {
		if (syntax == 'less') {
			return lessCtx.properties(node);
		}
	...
	function diffSections(s1, s2, options) {
		options = opt(options);
		var props1 = getProperties(s1, options.syntax);
		var props2 = getProperties(s2, options.syntax);
	...
	function sectionsEqual(s1, s2, options) {
		...
		// such checks
		var s1p = getProperties(s1, options.syntax), s2p = getProperties(s2, options.syntax);
