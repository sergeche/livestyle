...
define(function(require, exports, module) {
	...
	Expression.prototype = {
		...
		safeToken: function () {
			...
			if (!candidates.length && nstack[0] && nstack[0].type_ === TNUMBER) {
		...
		replaceSafeToken: function(value) {
			...
			var rt = function(value, token) {
				source = replaceSubstring(source, value, token);
			};
	...
	Parser.prototype = {
		parse: function (expr) {
			...
			return new Expression(tokenstack, object(this.ops1), object(this.ops2), object(this.functions), expr);
		},
